...
const Home = () => {
  ...
  const filteredMeals = useMemo(() => {
    ...
    return list;
  }, [search, activeCategory, sortKey, showVegOnly, priceRange]);

  return (
    <>
      <Navbar />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 text-[#111827]">
          ...
          {CATEGORIES.map((cat) => (
            <button
              ...
              className={`px-4 py-2 whitespace-nowrap rounded-full border ${
                activeCategory === cat
                  ? "bg-[#10B981] text-white border-black cursor-pointer"
                ...
                <div className="p-4 flex-1 flex flex-col">
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="px-3 py-2 bg-[#16A34A] text-white rounded-lg text-sm hover:bg-[#F97316] transition cursor-pointer"
                    >
                      Add
                    </button>
                  </div>
